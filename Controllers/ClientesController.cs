...
namespace crud_biblioteca.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Celular,Telefone,Cpf")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Celular,Telefone,Cpf")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
